...
export default function AppFooter(props) {
   ...
   return <footer className='app-footer'>
      <div className='row gap-5 text-center just-center '>
         <div className='col-1 pad-1 max-width-18'>
            <img src={freeDeliveryImg} style={{maxHeight: 64}} />
         ...
         <div className='col-1 pad-1 max-width-18'>
            <img src={emailImg} style={{maxHeight: 64}} />
         ...
         <div className='col-1 pad-1 max-width-18'>
            <img src={loveYouImg} style={{maxHeight: 64}} />
      ...
      <strong className='font-bold text-center'>This website are using fictional data. Any similarity with existing brands could be just coincidence.</strong>
         ...
         <div className='row-1  row-contact'>
            ...
            <div className='col-05 align-end'>
               ...
               <div className='row-1 align-start'>
                  <a href="mailto:jeckson.es@gmail.com" className='link-small font-87'> <img src={email32} style={{maxHeight: 24}} /> </a>
                  <a href="https://www.linkedin.com/in/jecksonschwengber/" className='link-small font-87'> <img src={linkedin32}  style={{maxHeight: 24}} /> </a>
                  <a href="https://www.jeckson.me/" className='link-small font-87'> <img src={www32} style={{maxHeight: 24}}  /> </a>
               </div>
